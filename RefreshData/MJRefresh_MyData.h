...
@property (copy, nonatomic) NSString * strewer ;

@property (copy, nonatomic) NSString * leaflet ;

@property (copy, nonatomic) NSString * telesms ;

@property (copy, nonatomic) NSString * rectification ;

@property (copy, nonatomic) NSString * untremulous ;
